...
- `docs/meeting_notes/2026-05-26/meeting_outline_20260526_router_pipeline_and_synthetic.md`
- `docs/development_records/2026-05-26-yolo-fallback/engineering_fallback_eval_20260526.md`
- `docs/development_records/2026-05-26-yolo-fallback/engineering_fallback_v3_signal_gated_20260526.md`
- `docs/development_records/2026-05-26-yolo-fallback/router_synthetic_mix_training_plan_20260526.md`

重点图片资产：

- `docs/development_records/assets/2026-05-26-yolo-fallback/fallback_compare_png`
...
```text
docs/meeting_notes/2026-05-26/meeting_outline_20260526_router_pipeline_and_synthetic.md
docs/development_records/assets/2026-05-26-yolo-fallback/fallback_compare_png/00_contact_sheet.png
outputs/router_eval/augv3_epoch14_test.log
...
1. 先阅读 `docs/meeting_notes/2026-05-26/meeting_outline_20260526_router_pipeline_and_synthetic.md`
2. 看 `docs/development_records/assets/2026-05-26-yolo-fallback/fallback_compare_png`，确认壁类展示与 fallback 的客户展示口径
