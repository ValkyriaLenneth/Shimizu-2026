...
5. 按 `docs/handoff_records/2026-06-02/downstream_dataset_restore_20260602.md` 重建下游 RF-DETR 数据集 view。
...
- 本文档和 `docs/handoff_records/2026-06-02/downstream_dataset_restore_20260602.md`
