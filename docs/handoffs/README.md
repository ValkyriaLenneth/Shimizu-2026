...
|---|---|---|---|
| 2026-05-19 | YOLO router, initial crack dataset, first end-to-end pipeline handoff | `docs/final_handoff_20260519.md`, `docs/handoffs/2026-05-19/README.md` | local package moved to `.local_artifacts/handoff_20260519/` |
| 2026-05-26 | YOLO best router, fallback/display logic, final synthetic router data | `docs/final_handoff_20260526.md`, `docs/handoffs/2026-05-26/README.md` | local package moved to `.local_artifacts/handoff_20260526/` |
| 2026-06-02 | RF-DETR migration start; router reaches Precision >= 0.90; RC column downstream validates RF-DETR | `docs/development_summary_20260602.md`, `docs/handoff_restore_20260602.md` | models/data are external artifacts |
| 2026-06-09 | RF-DETR downstream expansion, threshold tuning, RF-DETR production pipeline | `docs/rfdetr_work_summary_20260609.md`, `docs/meeting_rfdetr_downstream_expansion_20260609.md` | model packages are external artifacts |
| 2026-06-15 | Final release layout and RF-DETR pipeline evaluation | `final_release_20260615/MANIFEST.md`, `docs/pipeline_eval_20260615.md` | tracked folder keeps metadata only; data/models stay ignored |
| 2026-06-16 | RC wall report optimization and final display/report update | `docs/today_rc_wall_optimization_handoff_20260616.md`, `docs/pipeline_visual_error_analysis_20260616.md` | optimized model binaries stay external/ignored |
