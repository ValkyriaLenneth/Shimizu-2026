...
python scripts/train_rfdetr_router.py \
  ...
  --output-dir outputs/rfdetr_single_crack/tenjo_medium_e007_crop_b_hard_e6_fpfn3_res896_lr5e7_long \
  --device cuda:1 \
  --epochs 120 \
  --batch-size 14 \
  --lr 0.0000005 \
...
python scripts/sweep_rfdetr_router_test.py \
  --run-dir outputs/rfdetr_single_crack/tenjo_medium_e007_crop_b_hard_e6_fpfn3_res896_lr5e7_long \
  --dataset-dir data/rfdetr_tenjo_all_non_legacy_test_v1 \
  --epochs 0,1,2,4,8,16,32,64,96,119 \
  --output-csv outputs/rfdetr_single_crack/tenjo_medium_e007_crop_b_hard_e6_fpfn3_res896_lr5e7_long/test_results_selected.csv \
  --device cuda:1 \
  --batch-size 14 \
  --num-workers 8 \
  --precision 16-mixed
